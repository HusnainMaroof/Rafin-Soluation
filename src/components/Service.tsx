      ...
      <div className="container mx-auto px-6 lg:px-16 relative z-20 flex flex-col items-center text-center w-full">
        <StaggerContainer>
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 mb-6 leading-[1.1] tracking-tight flex flex-col md:flex-row flex-wrap justify-center gap-x-4">
            <StaggerItem>{service.title.split(" ")[0]}</StaggerItem>
            <StaggerItem>
...
export const ServiceOverview = ({ service }: { service: any }) => (
              ...
              {service.features.map((feature: any, idx: number) => (
                <React.Fragment key={idx}>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-slate-900 text-lg mb-2 group-hover:text-slate-800 transition-colors">
                        {feature.title}
                      </h4>
...
export const BentoFeaturesSection = ({ service }: { service: any }) => {
  return (
