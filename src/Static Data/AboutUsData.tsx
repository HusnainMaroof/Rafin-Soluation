import { Briefcase, Building2, PieChart, Scale, Search, ShieldCheck, Users } from "lucide-react";

export const expertiseData = [
  { icon: <Briefcase />, title: "Strategic", desc: "Long-term compliance roadmaps, regulatory positioning, and structural integration for entering new markets." },
  { icon: <Building2 />, title: "Business as Usual", desc: "Day-to-day compliance support, ongoing monitoring, and routine checks to ensure seamless operations." },
  { icon: <Search />, title: "Problem-Solving", desc: "Targeted interventions, audit remediation, and rapid response to complex regulatory inquiries or challenges." }
];
